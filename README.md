...
- [Notebooks](#notebooks)
  - [Analysis 1: SF Investigated Hate Crimes Dataset Analysis](https://github.com/jcsibajam/sf_hate_crimes/blob/dcb0739dfbf2ddb2aa41dc66d10bc1f568a2b109/Analysis%201%20-%20Police%20Department%20Investigated%20Hate%20Crimes%20Dataset.ipynb)
...
Hate crimes continue to be a significant issue in the United States, affecting groups based on race, religion, sexual orientation, gender identity, and other factors. The U.S. Department of Justice (n.d.) defines a hate crime as a criminal act motivated by bias against a person's identity, which can include physical violence, verbal harassment, threats, or property damage. These crimes harm individuals and create fear in whole communities, making them an important area of study.

Hate crimes can take many forms, ranging from harassment and bullying to physical attacks and intimidation (Patel et al., 2023). Despite their significant impact, many hate crimes go unreported. The U.S. Department of Justice (n.d.) estimates that between 2004 and 2015, an average of 250,000 hate crimes occurred each year in the U.S., yet more than half of these crimes (54%) were never reported to the police between 2011 and 2015. This underreporting makes it difficult to see the full picture of the problem. It highlights the need for research to bring attention to the actual number of reported cases and to identify which groups might not be reporting their experiences.

While media coverage occasionally brings attention to hate crime incidents, research into the relationship between hate crimes, hate groups, and location remains limited (Jendryke & McClure, 2019). Understanding where these crimes occur is just as important as knowing who is targeted. Geographic patterns can reveal high-risk areas, helping to identify whether hate crimes occur in specific neighborhoods or in areas already known for higher crime rates. Social and political movements also play a role in shaping the conversation around hate crimes. According to Malcom et al. (2024), recent movements such as Black Lives Matter have helped bring hate crime victimization to the forefront of discussions about social justice in the U.S. These movements emphasize the importance of understanding hate crimes in all forms, not just as isolated incidents but as part of a bigger society issue.

This research is particularly important in a city like San Francisco, which is known for its diverse and inclusive culture yet still experiences hate-motivated crimes. According to the United States Census Bureau (n.d.), 34% of San Francisco's population identifies as Asian and 16% as Hispanic or Latino, reflecting the city's multicultural identity. However, this diversity does not make the city immune to hate crimes. By analyzing hate crime reports in San Francisco from 2020 to 2024, this project intents to uncover patterns in who is most at risk and where these crimes are happening. Understanding these trends can contribute to ongoing discussions about safety, community support, and the need for better reporting mechanisms.

By combining insights from academic research, government data, and real-world crime reports, this project seeks to contribute to a deeper understanding of hate crimes in San Francisco, helping to inform future studies and discussions on social justice and public safety.
